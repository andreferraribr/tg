...
p_loa <- ggplot() + 
  geom_col(data = tg_total, aes( fill = fase_t, y=valor, x=ano_lan), alpha = 0.99, color = "gray", position="dodge", stat="identity")+
  scale_fill_manual( values = c("empenhado_total" = "#FFFFFF", "liquidado_total" = "#FFFFFF", "pago_total" = "#FFFFFF", "empenhado" = "#5c85d6", "liquidado" = "#1a66ff", "pago" = "#000066"  ))+
   ...
   geom_col(data = tg_fase_p, aes(fill= fase, y=valor, x=ano_lan), position="dodge", stat="identity")
